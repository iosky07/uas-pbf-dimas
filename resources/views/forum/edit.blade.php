            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <input type="text" name="tittle" class="form-control" value="{{$forum->tittle}}">
                  </div>
                  <div class="form-group">
                        ...
                        <div class="bg">
                          <div class="form-group">
                            ...
                            @if (empty($forum->image))
                              <small><i class="fa fa-info-circle"></i>Tidak ada gambar</small>
                            @else
                            <div class="form-group">
                               <div class="col-md-4">
        ...
        <div class="create_info" style="color: #fff;">
         <h5><i class="fa fa-info-circle"></i> Info</h5>
          ...
          <b>Pertanyaan terakhir edit:</b><br>
           <a href="#" style="color: #444"><h5 style="margin-top: 4px;"><i class="fa fa-newspaper-o"></i> {{$forum->tittle}}</h5></a>
