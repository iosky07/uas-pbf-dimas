  ...
  <div class="jumbotron" id="tc_jumbotron">
    <div class="card-body" id="xx">
        <div class="tc_head_title">
           <h2 style="color: #fff;">{{$forums->tittle}}</h2>
        </div>
    </div>
  </div>
</div>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-tittle" id="exampleModalLabel">Screenshot:</h5>
  ...
  <div class="card-body" style="background: #f9f9f9; ">
    <div class="row">
      <div class="col-md-3" id="img_comment">
        <img src="{{asset('images/person.png')}}" width="100%">
        <br>
            ...
            <div class="add_comment">
              ...
              @if (Auth::guest())
                <div class="comment-show" style="padding: 59px;">
                  <a href="{{route('login')}}"> <i class="fa fa-sign-in"></i> Login </a>to Comment.</p>
                </div>
              @else
