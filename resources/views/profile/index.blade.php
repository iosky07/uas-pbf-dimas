      ...
      <div class="card-body">
        <div class="text-center">
         <div class="profile_img">
           <img src="{{asset('images/person.png')}}" style="background: #fff;">
         </div>
          <div id="user_name">
            <h3>{{$user->name}}</h3>
            <br>
        ...
        <div class="col-md-12" id="tc_container_wrap">
           <div class="card" id="tc_paneldefault">
              <div class="card-body" id="tc_panelbody"  style="background: #f9f9f9;">
                 <div class="card">
                    <div class="card-header" style="background-color: #5476D4;">
           ...
           <div class="col-md-12">
            ...
            <tbody>
              @forelse($forums as $forum)
               <tr>
                <td>{{$forum->tittle}}<i style="font-size: 10px; color: #999;"> {{$forum->created_at->diffForHumans()}} min ago, Comments {{$forum->comments->count()}}</i>
                 </td>
